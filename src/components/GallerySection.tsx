  ...
  <section id="gallery" className="section-padding">
    <div className="container mx-auto">
      <div className="text-center mb-10 md:mb-16">
        <p className="text-primary/80 tracking-[0.3em] text-xs uppercase mb-3 md:mb-4">Our Work</p>
        <h2 className="font-heading text-3xl md:text-5xl text-primary mb-3 md:mb-4">Style Gallery</h2>
